        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          return new ListView(
            children: snapshot.data!.docs.map((DocumentSnapshot document) {
              return new ListTile(
                title: new Text((document.data() as Map<String, dynamic>)['appointmentDate']),
                subtitle: Column(
                  children: [
                    const Divider(
                      color: Colors.black,
                    ...
                    Row(
                      children: [
                        new Text("Name: "),
                        new Text((document.data() as Map<String, dynamic>)['name']),
                        new Text(" DOB: "),
                        new Text((document.data() as Map<String, dynamic>)['dob']),
                      ],
                    ),
                    Row(
                      children: [
                        new Text("ID Type: "),
                        new Text((document.data() as Map<String, dynamic>)['idType']),
                        new Text(" ID: "),
                        new Text((document.data() as Map<String, dynamic>)['id']),
                      ],
                    ),
                    Row(
                      children: [
                        new Text("Next Appt. Dt: "),
                        new Text((document.data() as Map<String, dynamic>)['newAppointmentDate']),
                      ],
                    ),
                    Row(
                      children: [
                        new Text("Occupation: "),
                        new Text((document.data() as Map<String, dynamic>)['occupation']),
                      ],
                    )
                  ],
                ),
